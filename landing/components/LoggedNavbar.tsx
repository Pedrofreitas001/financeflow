...
const LoggedNavbar: React.FC = () => {
    ...
    const planLabel = userPlan.isDiamond ? 'Diamond' : userPlan.isPremium ? 'Premium' : 'Free';
    const planStyles = userPlan.isDiamond
                ...
                <div className="flex items-center justify-between h-20">
                    ...
                    <div className="relative" ref={menuRef}>
                        <button
                            ...
                            className="flex items-center gap-3 px-3 py-2 rounded-full bg-white/5 border border-white/10 backdrop-blur-sm hover:bg-white/10 transition-colors"
                        >
                            ...
                            <div className="hidden sm:block text-left">
                                <div className="flex items-center gap-2">
                                    ...
                                    <span className={`text-[10px] px-2 py-0.5 rounded-full ${planStyles}`}>
                                        {planLabel}
                                    </span>
                                </div>
                            </div>
